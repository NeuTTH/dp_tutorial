...
main_path = "/Genomics/argo/users/tt1131/projects/periodic_AE/dp_tutorial/"
...
joints_seg = np.load(
    os.path.join(main_path, "datasets/joints_102723.npy"), allow_pickle=True
)
states = np.load(
    os.path.join(main_path, "datasets/states_102723.npy"), allow_pickle=True
)
